...
namespace Mango.Web.Service.IService
{
    ...
    {
        public static readonly string HTTP_STATUS_CODE_NOT_FOUND = "Not Found";
        public static readonly string HTTP_STATUS_CODE_ACCESS_DENIED = "Access Denied";
        public static readonly string HTTP_STATUS_CODE_UN_AUTHORIZED = "Unauthorized";
        public static readonly string HTTP_STATUS_CODE_INTERNAL_SERVER_ERROR = "Internal Server Error";
